...
if [[ -f /var/shc/userToRemove ]]; then
	U=`cat /var/shc/userToRemove`
	...
	rm -f /var/shc/userToRemove
else
	defaults write /Library/LaunchDaemons/com.searshc.adminremove.plist disabled -bool true
	echo "going to unload"
	launchctl unload -w /Library/LaunchDaemons/com.searshc.adminremove.plist
	echo "Completed"
	rm -f /Library/LaunchDaemons/com.searshc.adminremove.plist
fi
