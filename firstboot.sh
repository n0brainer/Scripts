...
TimeServer1=<internal time server>
...
# SearchDomains="<our internal search domains>"
...
defaults -currentHost write /Library/Preferences/com.apple.TimeMachine DoNotOfferNewDisksForBackup -bool true
...
#
defaults -currentHost write /System/Library/User\ Template/English.lproj/Library/Preferences/ByHost/com.apple.screensaver.$MAC_UUID "askForPassword" -int 1
#

defaults -currentHost write /System/Library/User\ Template/English.lproj/Library/Preferences/ByHost/com.apple.screensaver.$MAC_UUID "idleTime" -int 900

defaults -currentHost write /System/Library/User\ Template/English.lproj/Library/Preferences/ByHost/com.apple.screensaver.$MAC_UUID "moduleName" -string "Flurry"

defaults -currentHost write /System/Library/User\ Template/English.lproj/Library/Preferences/ByHost/com.apple.screensaver.$MAC_UUID "modulePath" -string "/System/Library/Screen Savers/Flurry.saver"
...
defaults -currentHost write "/System/Library/User Template/English.lproj/Library/Preferences/com.apple.alf" globalstate -int 1
...
/System/Library/CoreServices/RemoteManagement/ARDAgent.app/Contents/Resources/kickstart -activate -configure -users macadmin,jssdply -access -on  -privs -all -clientopts -setvnclegacy -vnclegacy yes -setvncpw -vncpw <password> -restart -agent -console
